...
function FastifyFile(fieldName, localOptions) {
    var _a;
...
const FastifyFileInterceptor = (fieldName, localOptions) => (0, common_1.UseInterceptors)(FastifyFile(fieldName, localOptions));
