...
function FastifyFiles(fieldName, maxCount, localOptions) {
...
const FastifyFilesInterceptor = (fieldName, maxCount, localOptions) => (0, common_1.UseInterceptors)(FastifyFiles(fieldName, maxCount, localOptions));
